...
export const TopBar = () => {
  ...
  return (
    <section className="flex h-16 shrink-0 items-center border-b px-4 gap-x-4 lg:gap-x-6 sm:px-6 lg:px-8 text-gray-900 dark:text-gray-50 border-gray-200 dark:border-gray-800">
