...
/**
 * Renders a collection of skeleton cards while the collection
 * is loaded from Chrome storage.
 */
...
const SkeletonCard = () => (
  <div className="flex-1 p-4 border border-gray-200 rounded-lg animate-pulse dark:border-gray-700">
